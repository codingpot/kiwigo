...
func TestExtractWord(t *testing.T) {
	...
	scanner := bufio.NewScanner(strings.NewReader(`2008년에는 애국가의 작곡자 안익태가 1930년대에 독일 유학 기간 중 친일 활동을 했다는 사실이 밝혀졌다. 이후 안익태가 나치 독일 하의
...
때문에 친일의 산물은 아니다.`))
	wordInfos, _ := kb.ExtractWords(scanner, 1 /*=minCnt*/, 100 /*=maxWordLen*/, -1000 /*=minScore*/, -1000 /*=posThreshold*/)
